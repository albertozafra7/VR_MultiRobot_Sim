...
public class URController : MonoBehaviour
{
    ...
    public bool IsSingularJointPosition(Vector<float> jointValues, List<DH.Param> dhParams)
    {
    ...
    public Matrix4x4 LocalTransformMatrix(Transform transform)
    {
        return Origin.transform.worldToLocalMatrix * transform.localToWorldMatrix;
    }

    public Vector<float> IK(Matrix4x4 T06, URConfiguration configuration)
    {
